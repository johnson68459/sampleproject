...
service CatalogService
{
    ...
    annotate LiabilityBasedOnAmount_1 with @UI.SelectionFields : 
    [
        years
    ];
    ...
    annotate TotalAccountsPayable_1 with @UI.SelectionFields : 
    [
        years
    ];
    ...
    annotate VendorLiabilityReportforCompanyCode_1 with @UI.SelectionFields : 
    [
        years
    ];
    ...
    @UI.DeleteHidden
    entity Invoice_child_items as
        projection on my.Invoice_child_items;

    @UI.DeleteHidden
    entity InvoiceApprover as
        projection on my.InvoiceApprover;

    @UI.DeleteHidden
    entity Approvers as
        projection on my.Approvers;

    @UI.DeleteHidden
    entity Invoice_overviewchart_1 as
        projection on my.Invoice_overviewchart_1;

    @UI.DeleteHidden
    entity AccountPayable_1 as
        projection on my.AccountPayable_1;

    @UI.DeleteHidden
    entity Liability as
        projection on my.Liability;

    @UI.DeleteHidden
    entity Tableyears as
        projection on my.Tableyears;

    @UI.DeleteHidden
    entity LiabilityBasedOnAmount_1 as
        projection on my.LiabilityBasedOnAmount_1;

    @UI.DeleteHidden
    entity TotalAccountsPayable_1 as
        projection on my.TotalAccountsPayable_1;

    @UI.DeleteHidden
    entity VendorLiabilityReportforCompanyCode_1 as
        projection on my.VendorLiabilityReportforCompanyCode_1;

    @UI.DeleteHidden
    entity Aging as
        projection on my.Aging;

    @UI.DeleteHidden
    entity Aging_aggregate as
        projection on my.Aging_aggregate;

    @UI.DeleteHidden
    entity Aging_bsd_comp_1 as
        projection on my.Aging_bsd_comp_1;

    @UI.DeleteHidden
    entity Processed_InProcessing_1 as
        projection on my.Processed_InProcessing_1;

    @UI.DeleteHidden
    entity Total_liabilities_1 as
        projection on my.Total_liabilities_1;

    entity Total_liabilities_2 as
        projection on my.Total_liabilities_2;

    @UI.DeleteHidden
    entity key_TotalAccountsPayable_1 as
        projection on my.key_TotalAccountsPayable_1;

    @UI.DeleteHidden
    entity Vendors as
        projection on my.Vendors;

    entity Vendorbasedonamount as
        projection on my.Vendorbasedonamount;

    entity Jan_Feb_Mar as
        projection on my.Jan_Feb_Mar;

    entity Oct_Nov_Dec as
        projection on my.Oct_Nov_Dec;

    @UI.DeleteHidden
    entity Productivity as
        projection on my.Productivity;

    @UI.DeleteHidden
    entity ProductivityReportOverview_1 as
        projection on my.ProductivityReportOverview_1;

    entity ProductivityReportOverviewdemo as
        projection on my.ProductivityReportOverviewdemo;

    @UI.DeleteHidden
    entity ProductivityReportOverview_2 as
        projection on my.ProductivityReportOverview_2;

    @UI.DeleteHidden
    entity Overview_page as
        projection on my.Overview_page;

    @UI.DeleteHidden
    entity Overview_page_1 as
        projection on my.Overview_page_1;

    @UI.DeleteHidden
    entity MyTask as
        projection on my.MyTask;
}
